...
// VRouterTarget is a pure data object; its content is consumed by
...
func (r *VRouterTargetReconciler) Reconcile(_ context.Context, _ ctrl.Request) (ctrl.Result, error) {
